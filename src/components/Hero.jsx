    ...
    return (
        <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 transition-colors duration-300">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 w-full flex flex-col items-center">
                ...
                >
                    {[
                        { icon: <Linkedin size={22} />, href: "https://www.linkedin.com/in/balu-parasa" },
                        { icon: <Github size={22} />, href: "https://github.com/Balu-parasa" },
                        { icon: <Mail size={22} />, href: "mailto:baluparasa3@gmail.com" }
                    ].map((social, index) => (
                        <a
                            key={index}
                            href={social.href}
